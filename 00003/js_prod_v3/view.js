...
function showText(text) {
    var messages = {
        ...
        'gameover': "<div class='centeredHeader unselectable'> Game Over <br/>" + score + " pts</div><br><div style='font-size:24px;' class='centeredHeader unselectable'> High Scores:</div><table class='tg' style='margin:0px auto'> "
    };
