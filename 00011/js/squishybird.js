...
var flap = loadGameSound('wav/flap.wav', 5);
var pipeslide = loadGameSound('wav/slide.wav', 3);
var clang = loadGameSound('wav/clang.wav', 3);

var coin1 = loadGameSound('wav/coin.wav', 3);
var coin2 = loadGameSound('wav/coin2.wav', 3);
var coin3 = loadGameSound('wav/coin3.wav', 3);
var coin4 = loadGameSound('wav/coin4.wav', 3);

var kick = loadGameSound('wav/kick.wav', 5);
var kick2 = loadGameSound('wav/kick2.wav', 5);
var kick3 = loadGameSound('wav/kick3.wav', 5);
var kick4 = loadGameSound('wav/kick4.wav', 5);
var kick5 = loadGameSound('wav/kick5.wav', 5);

var kicks = [kick, kick2, kick3, kick4, kick5];

var squish1 = loadGameSound('wav/squish1.wav', 3);
var squish2 = loadGameSound('wav/squish2.wav', 3);
...
parody.div.innerHTML = '请自行辨别虚拟网络与真实世界的差别，压扁小鸟仅为游戏设定，请勿上升至个人行为';
